...
if ($conn->connect_error) {
  ...
  function save ($conn){
    ...
    // $sql = "UPDATE motors SET degree= $motor1  WHERE id=1";
    // $sq2 = "UPDATE motors SET degree= $motor2  WHERE id=2";
    // $sq3 = "UPDATE motors SET degree= $motor3  WHERE id=3";
    // $sql = "UPDATE motors SET degree= $motor4  WHERE id=4";
    // $sql = "UPDATE motors SET degree= $motor5  WHERE id=5";
    // $sql = "UPDATE motors SET degree= $motor6  WHERE id=6";
